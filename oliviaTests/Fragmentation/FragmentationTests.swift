...
extension FragmentationTests {
    private final class CaptureDelegate: OliviaDelegate {
    ...
    private func makeLargePublicPacket(senderShortHex: PeerID, size: Int) -> OliviaPacket {
