...
- Address: iOS uses BLE MAC randomization; OLIVIA does not attempt to set static addresses.
...
- Relay policy variance: Some relays apply “web-of-trust” policies and may reject events; OLIVIA tolerates partial delivery and still prefers mesh when available.
