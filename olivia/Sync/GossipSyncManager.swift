...
final class GossipSyncManager {
    ...
    private var messages: [String: OliviaPacket] = [:] // idHex -> packet
    private var messageOrder: [String] = []
    private var latestAnnouncementByPeer: [String: (id: String, packet: OliviaPacket)] = [:]
    ...
    func onPublicPacketSeen(_ packet: OliviaPacket) {
    ...
    private func isPacketFresh(_ packet: OliviaPacket) -> Bool {
    ...
    private func _onPublicPacketSeen(_ packet: OliviaPacket) {
