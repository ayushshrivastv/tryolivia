...
/// Represents a user-visible message in the OLIVIA system.
/// Handles both broadcast messages and private encrypted messages,
/// with support for mentions, replies, and delivery tracking.
/// - Note: This is the primary data model for chat messages
final class OliviaMessage: Codable {
    let id: String
    let sender: String
    let content: String
    let timestamp: Date
...
extension OliviaMessage: Equatable {
    static func == (lhs: OliviaMessage, rhs: OliviaMessage) -> Bool {
...
extension Array where Element == OliviaMessage {
