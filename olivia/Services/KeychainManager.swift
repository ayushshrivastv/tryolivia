...
final class KeychainManager: KeychainManagerProtocol {
    ...
    private let service = OliviaApp.bundleID
    private let appGroup = "group.\(OliviaApp.bundleID)"
    ...
    private func isSandboxed() -> Bool {
        ...
        let testPath = homeDir.appendingPathComponent("../../../tmp/olivia_sandbox_test_\(UUID().uuidString)")
    ...
    private func saveData(_ data: Data, forKey key: String) -> Bool {
        ...
        var base: [String: Any] = [
            ...
            kSecAttrLabel as String: "olivia-\(key)"
        ]
        #if os(macOS)
        ...
        if searchStatus == errSecSuccess, let items = result as? [[String: Any]] {
            for item in items {
                ...
                if accessGroup == appGroup {
                    ...
                    "com.olivia.passwords",
                    "com.olivia.deviceidentity",
                    "com.olivia.noise.identity",
                    "chat.olivia.passwords",
                    "olivia.keychain",
                    "olivia",
                    "com.olivia"
                ].contains(service) {
