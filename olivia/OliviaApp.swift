...
@main
struct OliviaApp: App {
    static let bundleID = Bundle.main.bundleIdentifier ?? "chat.olivia"
    ...
    private func handleURL(_ url: URL) {
        if url.scheme == "olivia" && url.host == "share" {
    ...
    private func checkForSharedContent() {
        ...
        guard let userDefaults = UserDefaults(suiteName: OliviaApp.groupID) else {
            return
        }
