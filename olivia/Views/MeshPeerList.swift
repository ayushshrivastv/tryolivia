...
struct MeshPeerList: View {
    ...
    var body: some View {
        ...
        let mapped: [(peer: OliviaPeer, isMe: Bool, hasUnread: Bool, enc: EncryptionStatus)] = viewModel.allPeers.map { peer in
        ...
        let peers: [(peer: OliviaPeer, isMe: Bool, hasUnread: Bool, enc: EncryptionStatus)] = displayIDs.compactMap { id in
